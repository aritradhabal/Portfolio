  ...
  projects: [
    {
      ...
      active: true,
      description:
        "HashX is a decentralized prediction market for off-chain events built on Hedera. It uses timelock puzzles for secure oracle resolution. It features privacy-preserving, encrypted voting and Merkle-proof based reward distribution.",
      technologies: [
        "Next.js",
        "Typescript",
        "PostgreSQL",
      ...
      links: [
        {
          type: "Website",
          href: "https://hashx-live.vercel.app",
          icon: <Icons.globe className="size-3" />,
        },
        {
          type: "Source",
          href: "https://github.com/aritradhabal/hashX",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "",
      video:
        "https://pub-74c3ed08843449e6ae368362f8db21ad.r2.dev/AfterSequence%2001%2012%3A58%E2%80%AFpm.mp4",
    },
    {
      title: "PrepPal",
      href: "#projects",
  ...
  hackathons: [
    {
      ...
      location: "Online",
      description:
        "Participated in ETHGlobal Online 2025 for developing a decentralized prediction market and Optimistic Oracle for off-chain events built on Hedera. It uses timelock puzzles for secure oracle resolution. It features privacy-preserving, encrypted voting and Merkle-proof based reward distribution.",
      image: "ethonline.png",
      win: true,
      mlh: "",
      links: [
    ...
    },
    {
      ...
      location: "New Delhi",
      description:
        "Participated in ETHGlobal New Delhi 2025 for developing a decentralized privacy preserving alternative to the infamous 'Tea For Women' app using WorldID for identity verification & Walrus for secure storage.",
      image: "ethdelhi.png",
      win: true,
      mlh: "",
      links: [
        {
          title: "Project",
          icon: <Icons.github className="h-4 w-4" />,
          href: "https://github.com/aritradhabal/ethmatch-frontend",
        },
        {
          title: "Website",
          icon: <Icons.globe className="h-4 w-4" />,
          href: "https://ethglobal.b0bd725bc77a3ea7cd3826627d01fcb6.r2.cloudflarestorage.com/certificates/176804/certificate.pdf?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Credential=dd28f7ba85ca3162a53d5c60b5f3dd05%2F20251031%2Fauto%2Fs3%2Faws4_request&X-Amz-Date=20251031T073953Z&X-Amz-Expires=3600&X-Amz-Signature=5383fe811f544f2a92a6a1747332c75ee797ad2c563759280323a22db3dcf324&X-Amz-SignedHeaders=host&x-amz-checksum-mode=ENABLED&x-id=GetObject",
        },
      ],
    },
    {
